    ...
    <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-12">
      <div className="mb-8 text-center sm:mb-10">
        ...
        <p className="mx-auto mt-2 max-w-2xl text-sm leading-relaxed text-white/50">
          En RG Motors eliges el vehículo; el crédito lo evalúa Autofin. Aquí ves una cuota
          del <b className="font-semibold text-white/70">escenario normal</b> (realista). En
          sucursal, según tu evaluación, esa cuota puede mantenerse o mejorar.
        </p>
      </div>
