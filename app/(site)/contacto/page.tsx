    ...
    <main className="mx-auto max-w-5xl px-4 py-12 sm:px-6">
      <div className="mb-8 border-b border-white/[0.08] pb-6">
        ...
        <p className="mt-1 text-sm text-white/50">
          Te asesoramos en la compra o venta de tu vehículo en Puerto Montt.
        </p>
      </div>
      ...
      <div className="grid items-start gap-8 lg:grid-cols-[1.3fr_1fr]">
        ...
        <div className="space-y-3.5">
          <Info icon="📍" title="Showroom" text={COMPANY.address} />
          ...
          <a
            ...
            className="flex items-center gap-3.5 rounded-3xl border border-[#25D366]/30 bg-[#25D366]/10 p-4 backdrop-blur-md transition hover:bg-[#25D366]/20"
          >
            <span className="text-2xl">💬</span>
            <div>
              <p className="text-xs font-bold text-[#25D366]">Atención prioritaria por WhatsApp</p>
              <p className="text-xs text-white/60">Horario comercial · {COMPANY.phoneDisplay}</p>
            </div>
          </a>
          ...
          <div className="grid grid-cols-2 gap-3 pt-1">
            ...
            >
              ...
              <p className="text-[11px] text-white/60">Red oficial RG Motors</p>
            </a>
          </div>
        </div>
      </div>
