        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-6 px-4 py-3.5 sm:px-6">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="hidden items-center gap-2 border-l border-white/15 pl-4 text-xs font-semibold text-white/90 transition duration-300 hover:text-white sm:inline-flex"
            >
            ...
            <button
              ...
              className="grid h-9 w-9 place-items-center rounded-full border border-white/12 text-white/80 transition hover:border-white/25 hover:bg-white/5 md:hidden"
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="mt-3 flex flex-col gap-2 border-t border-white/[0.06] pt-4">
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={() => setMobileMenuOpen(false)}
                  className="flex items-center justify-center rounded-full bg-[#25D366] py-3 text-sm font-semibold text-white"
                >
                  WhatsApp
                </a>
                <Link
